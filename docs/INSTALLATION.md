# Produktionsinstallation v0.2.43
...
Fuer reproduzierbare Rollbacks steht zusaetzlich der Versions-Tag `ghcr.io/syschelle/schulungsplantool:0.2.43` zur Verfuegung.
