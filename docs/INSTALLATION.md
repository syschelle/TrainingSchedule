# Produktionsinstallation v0.2.37
...
Fuer reproduzierbare Rollbacks steht zusaetzlich der Versions-Tag `ghcr.io/syschelle/schulungsplantool:0.2.37` zur Verfuegung.
