# Produktionsinstallation v0.3.0
...
Fuer reproduzierbare Rollbacks steht zusaetzlich der Versions-Tag `ghcr.io/syschelle/schulungsplantool:0.3.0` zur Verfuegung.
