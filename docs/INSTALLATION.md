# Produktionsinstallation v0.2.32
...
Fuer reproduzierbare Rollbacks steht zusaetzlich der Versions-Tag `ghcr.io/syschelle/schulungsplantool:0.2.32` zur Verfuegung.
