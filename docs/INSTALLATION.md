# Produktionsinstallation v0.4.5
...
Fuer reproduzierbare Rollbacks steht zusaetzlich der Versions-Tag `ghcr.io/syschelle/schulungsplantool:0.4.5` zur Verfuegung.
