# Produktionsinstallation v0.4.1
...
Fuer reproduzierbare Rollbacks steht zusaetzlich der Versions-Tag `ghcr.io/syschelle/schulungsplantool:0.4.1` zur Verfuegung.
