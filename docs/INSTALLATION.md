# Produktionsinstallation v0.3.8
...
Fuer reproduzierbare Rollbacks steht zusaetzlich der Versions-Tag `ghcr.io/syschelle/schulungsplantool:0.3.8` zur Verfuegung.
